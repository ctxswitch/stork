...
describe "Stork::Objects::Host" do
  ...
  #
  #   distro = Stork::Objects::Distro.build("centos") do
  #     kernel "vmlinuz"
  #     image "initrd.img"
  #     url "http://mirror.example.com/centos"
  #   end
  #
  #   layout = Stork::Objects::Layout.build("default") do
  #     clearpart
  #     zerombr
  #     part "/boot" do
  #       size 100
  ...
  #   end
  #
  #   chef = Stork::Objects::Chef.build("default") do
  #     url "https://chef.example.org"
  #     version "11.6.0"
  #     client_name "root"
  #     client_key ckey
  ...
  #   end
  #
  #   snip = Stork::Objects::Snippet.new(File.dirname(__FILE__) + '/files/configs/snippets/noop.erb')
  #
