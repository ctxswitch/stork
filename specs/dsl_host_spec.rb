...
describe "Midwife::DSL::Host" do
  it "must create a host" do
    Midwife::DSL::Host.new("example.org").must_be_instance_of Midwife::DSL::Host
  end

  it "must respond to the name method" do
    Midwife::DSL::Host.new("example.org").must_respond_to :name
  end

  it "must respond to the layout accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :layout
    Midwife::DSL::Host.new("example.org").must_respond_to :layout=
  end

  it "must respond to the template accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :template
    Midwife::DSL::Host.new("example.org").must_respond_to :template=
  end

  it "must respond to the chef accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :chef
    Midwife::DSL::Host.new("example.org").must_respond_to :chef=
  end

  it "must respond to the pxemac accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :pxemac
    Midwife::DSL::Host.new("example.org").must_respond_to :pxemac=
  end

  it "must respond to the pre_snippets accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :pre_snippets
    Midwife::DSL::Host.new("example.org").must_respond_to :pre_snippets=
  end

  it "must respond to the post_snippets accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :post_snippets
    Midwife::DSL::Host.new("example.org").must_respond_to :post_snippets=
  end

  it "must respond to the interfaces accessors" do
    Midwife::DSL::Host.new("example.org").must_respond_to :interfaces
    Midwife::DSL::Host.new("example.org").must_respond_to :interfaces=
  end
  ...
  #   end
  #
  #   layout = Midwife::DSL::Layout.build("default") do
  #     clearpart
  #     zerombr
  #     part "/boot" do
  #       size 100
  ...
  #   end
  #
  #   chef = Midwife::DSL::Chef.build("default") do
  #     url "https://chef.example.org"
  #     version "11.6.0"
  #     client_name "root"
  #     client_key ckey
