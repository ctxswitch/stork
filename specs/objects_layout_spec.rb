...
describe "Stork::Objects::Layout" do
  it "should be created" do
    Stork::Objects::Layout.new('test').must_be_instance_of Stork::Objects::Layout
  end

  it "should respond to the name method" do
    Stork::Objects::Layout.new('test').must_respond_to :name
  end

  it "should respond to the zerombr accessors" do
    Stork::Objects::Layout.new('test').must_respond_to :zerombr
    Stork::Objects::Layout.new('test').must_respond_to :zerombr=
  end

  it "should respond to the clearpart accessors" do
    Stork::Objects::Layout.new('test').must_respond_to :clearpart
    Stork::Objects::Layout.new('test').must_respond_to :clearpart=
  end

  it "should respond to the partitions accessors" do
    Stork::Objects::Layout.new('test').must_respond_to :partitions
    Stork::Objects::Layout.new('test').must_respond_to :partitions=
  end

  it "requires a block for partition during build" do
    proc {
      layout = Stork::Objects::Layout.build('test') do
        zerombr
        clearpart
        part '/'
      end
